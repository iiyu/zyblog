            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a id="batchDel" href="/SIRzhouHome/index.php/Admin/Fenlei/pidele"><i class="icon-font"></i>批量删除</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">                 
                        ...
                        <td>
                            <a href="/SIRzhouHome/index.php/Admin/System/doReduction/name/<?php echo ($vo["name"]); ?>" onclick="return shifou();"><button type="button" class="btn btn-w-m btn-info">还原</button></a>
                            <a href="/SIRzhouHome/index.php/Admin/System/delData/name/<?php echo ($vo["name"]); ?>" onclick="return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
