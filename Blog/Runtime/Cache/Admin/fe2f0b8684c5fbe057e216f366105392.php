...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/SIRzhouHome/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">留言管理</span></div>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">                 
                       ...
                       <td class="tc"><input name="id[]" value="<?php echo ($vo["id"]); ?>" type="checkbox"></td>
                            ...
                            <td><?php echo (msubstr(strip_tags($vo["content"]),0,15,'utf-8',false)); ?></td>
                             <td><?php echo ($vo["ip"]); ?></td>
                            <td><?php echo (date( "Y-m-d H:i:s",$vo["ctime"])); ?></td>
                            <td>
                                <a class="link-del" href="/SIRzhouHome/index.php/Admin/Liuyan/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
...
<script type="text/javascript">
    ...
    $("#batchDel").click(function(){
        ...
        var url="/SIRzhouHome/index.php/Admin/Liuyan/deall";
        ...
        $.post(url, {"arr":arrdata},
            function(data){
                alert(data);
                location.href="/SIRzhouHome/index.php/Admin/Liuyan/index";
             });
    });
</script>
</html>