            ...
            <form name="myform" id="myform" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr id="vid">
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["id"]); ?>" type="checkbox">
                            </td>
                            <td><?php echo ($vo["id"]); ?></td>
                            <td><a href="/SIRzhouHome/index.php/Admin/Xiangce/xiangpian/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
                            <td><?php echo (date( "Y-m-d H:i:s",$vo["ctime"])); ?></td>
                            <td>
                                <a class="link-update" href="/SIRzhouHome/index.php/Admin/Xiangce/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="/SIRzhouHome/index.php/Admin/Xiangce/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
...
<script type="text/javascript">
    ...
    $("#batchDel").click(function(){
        ...
        var url="/SIRzhouHome/index.php/Admin/Xiangce/deall";
        ...
        $.post(url, {"arr":arrdata},
            function(data){
                alert(data);
                location.href="/SIRzhouHome/index.php/Admin/Xiangce/index";
             });
    });
</script>
</html>