...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/SIRzhouHome/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/SIRzhouHome/index.php/Admin/Fenlei/index">分类管理</a><span class="crumb-step">&gt;</span><span>新增分类</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/SIRzhouHome/index.php/Admin/Fenlei/doadd" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="pid" id="catid" class="required">
                                    ...
                                    <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo str_repeat("-",$vo['count']-2); echo ($vo["name"]); ?>
