                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr id="vid">
                            ...
                            <td><?php echo ($vo["view"]); ?></td>
                            <td>
                                <a class="link-update" href="/SIRzhouHome/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="/SIRzhouHome/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
...
<script type="text/javascript">
    ...
    $("#batchDel").click(function(){
        ...
        var url="/SIRzhouHome/index.php/Admin/Article/deall";
        ...
        $.post(url, {"arr":arrdata},
            function(data){
                alert(data);
                location.href="/SIRzhouHome/index.php/Admin/Article/index";
             });
    });
</script>
</html>