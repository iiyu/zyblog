...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">博文管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/admin/Friendlink/add"><i class="icon-font"></i>新增链接</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr id="vid">
                            <td class="tc"><input name="id[]" value="<?php echo ($vo["id"]); ?>" type="checkbox">
                            </td>
                            ...
                            <td>
                                <a class="link-update" href="/admin/Friendlink/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="/admin/Friendlink/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
...
<script type="text/javascript">
    ...
    $("#batchDel").click(function(){
        ...
        var url="/admin/Friendlink/deall";
        ...
        $.post(url, {"arr":arrdata},
            function(data){
                alert(data);
                location.href="/admin/Friendlink/index";
             });
    });
</script>
</html>