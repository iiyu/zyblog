...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/SIRzhouHome/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">分类管理</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/SIRzhouHome/index.php/Admin/Fenlei/add"><i class="icon-font"></i>新增分类</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">                 
                        ...
                        <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; echo str_repeat("　",$vo['count']-2);?>
                        <tr>
                       <td class="tc"><input name="id[]" value="<?php echo ($vo["id"]); ?>" type="checkbox"></td>
                            <td><?php echo ($vo["id"]); ?></td>
                            <td ><a href="#">
                            <if>
                            <?php echo str_repeat("∟",$vo['count']-2); echo ($vo["name"]); ?></a>
                            </td>
                            <td>
                                <a class="link-update" href="/SIRzhouHome/index.php/Admin/Fenlei/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="/SIRzhouHome/index.php/Admin/Fenlei/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
