...
.login-box{width:410px;margin:120px auto 0 auto;text-align:center;padding:30px;background:url(/SIRzhouHome/Public/Admin/images/login/mask.png);border-radius:10px;}
...
button{cursor:pointer;width:100%;height:44px;padding:0;background:#758353;border:1px solid #D1B8E0;border-radius:6px;font-weight:700;color:#fff;font-size:24px;letter-spacing:15px;text-shadow:0 1px 2px rgba(0,0,0,.1)}
...
<script type="text/javascript" src="/SIRzhouHome/Public/Admin/js/jquery-1.8.2.min.js"></script>
...
<div class="login-box">
	<h1>SIR周--博客管理后台登录</h1>
	<form method="post" action="/SIRzhouHome/index.php/Admin/Login/checklogin">
		<div class="name">
			<label>管理员账号：</label>
		...
		<div class="code">
			<label>验证码：</label>
			<input type="text" name="verify" maxlength="5" id="code" tabindex="3"/>
			<div class="codeImg">
				<img src="<?php echo U('Admin/Login/verify_c');?>"onclick="this.src=this.src+'?'""/>
			</div>
		</div>
		<div class="remember">
...
<div class="bottom">©2014 Leting <a href="javascript:;" target="_blank">关于</a> <span>周</span></div>

<div class="screenbg">
	<ul>
		<li><a href="javascript:;"><img src="/SIRzhouHome/Public/Admin/images/login/0.jpg"></a></li>
		<li><a href="javascript:;"><img src="/SIRzhouHome/Public/Admin/images/login/1.jpg"></a></li>
		<li><a href="javascript:;"><img src="/SIRzhouHome/Public/Admin/images/login/2.jpg"></a></li>
	</ul>
</div>
