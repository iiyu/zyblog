    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/admin/Fenlei/doedit/id/<?php echo ($id); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="pid" id="catid" class="required"> 
                                    ...
                                    <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['id'] == $id): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo str_repeat("-",$vo['count']-2); echo ($vo["name"]); ?>
                                        </option>
                                    <?php else: ?>
