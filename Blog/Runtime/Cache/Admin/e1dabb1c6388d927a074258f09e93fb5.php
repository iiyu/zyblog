            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/SIRzhouHome/index.php/Admin/Diary/add"><i class="icon-font"></i>新增日记</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr id="vid">
                            ...
                            <td>
                                <a class="link-del" href="/SIRzhouHome/index.php/Admin/Diary/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
...
<script type="text/javascript">
    ...
    $("#batchDel").click(function(){
        ...
        var url="/SIRzhouHome/index.php/Admin/diary/deall";
        ...
        $.post(url, {"arr":arrdata},
            function(data){
                alert(data);
                location.href="/SIRzhouHome/index.php/Admin/Diary/index";
             });
    });
</script>
</html>